...
it('renders primary actions in the header and separates qr sharing from runtime summary', async () => {
  ...
  expect(screen.queryByRole('region', { name: 'Sessions Preview' })).not.toBeInTheDocument();
  expect(screen.queryByRole('region', { name: 'Workspace Files Preview' })).not.toBeInTheDocument();
