...
Examples:
    init_skill.py my-new-skill --path ./draft-skills
    init_skill.py my-new-skill --path ./draft-skills --resources scripts,references
    init_skill.py my-api-helper --path ./draft-skills --resources scripts --examples
